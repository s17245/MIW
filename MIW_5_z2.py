...
data_train, data_test, descrData_train, descrData_test = train_test_split(data,descrData, test_size=0.333)
...
model.fit(data_train, descrData_train, epochs=150, batch_size=32, verbose=0)
